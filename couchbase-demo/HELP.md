...
* The following dependencies are not known to work with Spring Native: 'Spring Boot DevTools, Spring Data Couchbase'. As
...
```
$ docker run --rm -p 8080:8080 couchbase-demo:0.0.1-SNAPSHOT
```
